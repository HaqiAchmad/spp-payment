...
public class TambahDataPetugas extends javax.swing.JFrame {
    ...
    private void btnResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetActionPerformed
        ...
        this.inpGender.setSelectedItem("Laki-Laki");
        this.inpTempatLahir.setText("");
        this.inpTanggalLahir.setDate(new Date(01, 0, 01));
        this.inpAlamat.setText("");
        this.inpNoHp.setText("");
        this.inpEmail.setText("");
        this.inpLevel.setSelectedItem("Admin");
        this.inpPassword.setText("");
        this.inpKonfirmasi.setText("");
