...
public class DataSiswa {
    ...
    /**
     * Direktori dari penyimpanan foto profile.
     */
        ...
        try{
            ...
            if(ValidationSiswa.isValidData(data)){
                ...
                if(!ValidationSiswa.isExistNis(nis) && !ValidationSiswa.isExistEmail(gmail) && !ValidationSiswa.isExistNoHp(nohp)){
                    ...
                    // mentranfer data foto profile
                    boolean tProfile = DataSiswa.transferFotoProfile(nis, foto);
                    
                    // mengecek apakah proses eksekusi berhasil atau tidak
                    if(result > 0 && tProfile){
     ...
     * berada didalam class <code>ValidationSiswa</code>.
     * <br><br>
     ...
     * dari siswa melalui class <code>CreateDataSiswa</code>. Jika data-data dari siswa berhasil dibuat 
     ...
     * <code>isProfile(String foto)</code> yang berada didalam class <code>ValidationSiswa</code>.
     * <br><br>
     ...
     */
    private static boolean transferFotoProfile(String id, String foto){
        try {
            ...
            if(!siswa.isExistUser(id)){
                ...
                if(ValidationSiswa.isNis(id) && ValidationSiswa.isProfile(foto) && !foto.equalsIgnoreCase("default.png")){
    ...
    public static void main(String[] args) {
        ...
        //        DataSiswa.transferAllData();
        try {
            DataSiswa.downloadAllPhotos(System.getProperty("user.home")+"\\Desktop\\downloads\\");
